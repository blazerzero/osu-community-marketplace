$(document).ready(function() {
	...
	while (len >= 0) {
		if (len >= 3) {
		    ...
		    +    	((savedListings[len].imageIDs.length == 0 || savedListings[len].imageIDs[0] == '') ? '' : '<img src="http://www.worksbythepg.com/osucm-images/'+savedListings[len].type[0]+'/'+savedListings[len].imageIDs[0]+'" class="main-listing-img" alt="listing image">')
		    +      	'<p class="card-text">'+buildDescription(savedListings[len].description)+'</p>'
		    ...
		    +		'<p class="card-text">Campus: '+(savedListings[len].campus == 'Bend' ? 'Bend (Cascades)' : (savedListings[len].campus == 'Other' ? 'Other (See description)' : savedListings[len].campus))+'</p>'
		    +    	((savedListings[len-1].imageIDs.length == 0 || savedListings[len-1].imageIDs[0] == '') ? '' : '<img src="http://www.worksbythepg.com/osucm-images/'+savedListings[len-1].type[0]+'/'+savedListings[len].imageIDs[0]+'" class="main-listing-img" alt="listing image">')
		    +      	'<p class="card-text">'+buildDescription(savedListings[len-1].description)+'</p>'
		    ...
		    +		'<p class="card-text">Campus: '+(savedListings[len].campus == 'Bend' ? 'Bend (Cascades)' : (savedListings[len].campus == 'Other' ? 'Other (See description)' : savedListings[len].campus))+'</p>'
		    +    	((savedListings[len-2].imageIDs.length == 0 || savedListings[len-2].imageIDs[0] == '') ? '' : '<img src="http://www.worksbythepg.com/osucm-images/'+savedListings[len-2].type[0]+'/'+savedListings[len-2].imageIDs[0]+'" class="main-listing-img" alt="listing image">')
		    +      	'<p class="card-text">'+buildDescription(savedListings[len-2].description)+'</p>'
