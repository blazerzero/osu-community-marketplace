$(document).ready(function() {
	...
	while (len > 0) {
		if (len >= 3) {
		    ...
		    +   '<div class="card">'
		    +     '<div class="card-body">'
		    +		'<button type="button" class="close deleteSavedListingX" aria-label="Close" data-id="'+len+'">'
		    ...
		    + 	'<div class="card">'
		    +     '<div class="card-body">'
		    +		'<button type="button" class="close deleteSavedListingX" aria-label="Close" data-id="'+(len-1)+'">'
        	+		  '<span aria-hidden="true">&times;</span>'
        	+	  	'</button>'
		    +      	'<h5 class="card-title">Listing Title</h5>'
		    +    	'<img src="./splash/corvallis.jpg" class="main-listing-img" alt="listing image">'
